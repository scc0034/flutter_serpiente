...
\imagen{burndowns/sp1.png}{Sprint 6. }
...
En Flutter son conocidos como \emph{packages}, paquetes que ofrecen funcionalidades que ya han sido implementadas. Todas ellas se pueden encontrar en la siguiente \href{https://pub.dev/}{web}. Estos se integran en el fichero \texttt{pubspec.yaml}, siendo este muy importante. Para el proyecto se usaron: 
