...
\imagen{burndowns/sp1.png}{Sprint 1.}\label{sp1}
...
\subsection{Sprint 5 (11/07/20 - 15/07/20)}\label{sprint-5-11072020---15072020}
...
\imagen{burndowns/sp6.png}{Sprint 6. }
...
Se desglosa el coste de los dispositivos usados para la implementación, suponiendo que la amortización del PC de sobremesa es aproximadamente de 5 años y de 2 años para el \emph{smartphone}, con la duración del proyecto de 1 mes. Ver tabla~\ref{table:costehw}
...
El proyecto fue llevado por un solo trabajador (Samuel Casal Cantero), ya que es un proyecto unipersonal, que se encargaba del desarrollo de software y la planificación. El tiempo inicialmente estimado fue de 250 horas. Siendo el trabajador autónomo se considera el siguiente salario, ver tabla~\ref{table:costepersonal}:
...
En lo referente a las cuotas de la seguridad social, para el año 2020, tenemos que la cuota mínima a pagar es el resultado de aplicar el 30,3\% al salario mínimo interprofesional~\cite{xurxodev:smi} que es de 944,4 €, dando lugar a que esta cuota sea de 286,15 €. Dependiendo de la contingencia el desglose, ver en la tabla~\ref{table:costecuota}:
...
Son otro tipo de gastos que también se deben tener en cuenta. Ver tabla~\ref{table:costevario}
...
\subsubsection{Margen de beneficios}
...
\begin{table}[H]
	...
	\begin{tabular}{l l l l}
		...
		Flutter    & 1.17    & \begin{tabular}[c]{@{}l@{}}Framework usado en\\ desarrollar la app\end{tabular}                     
		& BSD 3-Clause \\
		...
		& MIT \\
		Firebase console    & 5.5    & \begin{tabular}[c]{@{}l@{}}Herramienta de Google\\ gestión servicios.\end{tabular}                     
		& Gratis \\
		Play Store console    & --    & \begin{tabular}[c]{@{}l@{}}Backend developers\\ tienda apps\end{tabular}                     
...
En la siguiente tabla~\ref{table:fuenteimagenes}, se muestran las fuentes del material gráfico.
...
El material musical tiene como fuentes las que se encuentran en la tabla~\ref{table:fuentesonido}
...
En Flutter son conocidos como \emph{packages}, paquetes que ofrecen funcionalidades que ya han sido implementadas. Todas ellas se pueden encontrar en la siguiente \href{https://pub.dev/}{web}. Estos se integran en el fichero \texttt{pubspec.yaml}, siendo este muy importante. Para el proyecto se usaron: (ver tabla~\ref{table:paquetes}) 
...
\begin{table}[H]
	...
	\begin{tabular}{l l l l}
		...
		flutter email sender & 	3.0.1 & \begin{tabular}[c]{@{}l@{}}Envió correos\\  \end{tabular} & Apache 2.0\\
