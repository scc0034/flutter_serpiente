...
\begin{itemize}
\item \textbf{./}
Directorio raíz del que cuelgan todas los demás ficheros. Este contiene uno de los archivos más importantes, que es es \path{pubspec.yalm}. Este archivos se usa para hacer las importaciones de los paquetes con las funcionalidades que queramos dar a nuestra aplicación.
...
\begin{itemize}
	...
	\begin{itemize}
		...
		\begin{figure}%[H]
			\centering
			\includegraphics[width=1.0\textwidth]{/techprog/google-services.jpg}
		...
		\begin{figure}%[H]
			\centering
			\includegraphics[width=1.0\textwidth]{techprog/app_build_gradle.jpg}
...
\begin{figure}%[H]
	\centering
	\includegraphics[width=1.0\textwidth]{/techprog/variablesEntorno.jpg}
...
\begin{figure}%[H]
	\centering
	\includegraphics[width=1.0\textwidth]{/techprog/version.jpg}
...
\begin{figure}%[H]
	\centering
	\includegraphics[width=1.0\textwidth]{/techprog/vm.jpg}
...
\begin{figure}%[H]
	\centering
	\includegraphics[width=1.0\textwidth]{/techprog/firebase.jpg}
...
\begin{figure}%[H]
	\centering
	\includegraphics[width=1.0\textwidth]{/techprog/playstore.jpg}
...
\begin{enumerate}
	...
	\begin{figure}%[H]
		\centering
		\includegraphics[width=0.8\textwidth]{/techprog/clonar.png}
