...
\begin{enumerate}
	...
	Es necesario que se permanezca los segundos indicados para volver a poder jugar.
...
Es la pantalla inicial del juego~\ref{fig:cuatromenu}, ya que siendo en modo online, uno de los jugadores debe de ser el creador de la  partida~\ref{fig:cuatroinvitar} (\emph{invite friend}) y el otro que se una~\ref{fig:cuatroinvitar} (\emph{join game}), a la partida creada.
...
En el caso de que el contador del tiempo restante \emph{time left}, llegue a cero es porque se da por hecho que por parte del invitado no tenemos respuesta.
...
Cuando se pulsa en el botón de compartir nos sale un cuadro de diálogo mostrando las aplicaciones que facilitan el envío de la clave.

\begin{figure}[H]
	\centering
	\includegraphics[height=0.8\textwidth]{manual/sharegame.jpg}
