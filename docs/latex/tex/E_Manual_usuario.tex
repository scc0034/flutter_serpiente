...
Página con el contenido del juego~\ref{fig:cuatrojuego}. Este consiste en formar líneas de longitud cuatro, en cualquiera de las direcciones posibles: diagonal, vertical y horizontal. Una vez se produce este suceso se finalizará la partida.

\begin{figure}[H]
	\centering
	\includegraphics[height=0.8\textwidth]{manual/cuatrojuego.jpg}
