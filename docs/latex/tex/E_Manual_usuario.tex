...
\begin{figure}[H]
	...
	\caption{Sign Out}\label{fig:settingspage}
\end{figure}
...
\subsection{Menú de juegos}
En este apartados se nos muestra una lista con todos los juegos de la colección que están disponibles, la finalidad es que el usuario pueda decidir, de una manera sencilla a qué quiere jugar. Por lo que es tan simple como pulsar en la opción correspondiente~\ref{fig:gamespage}.
