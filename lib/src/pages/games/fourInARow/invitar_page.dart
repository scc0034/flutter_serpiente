...
class _InvitarPageState extends State<InvitarPage> {
          ...
          Row(
            ...
            children: <Widget>[
              ...
              GestureDetector(
                ...
                onTap: () async {
                  var response =
                      await FlutterShareMe().shareToSystem(msg: _codigo);
                  if (response == 'success') {
  ...
  Future<void> _crearPartida() async {
    DocumentReference docPartidaNew =
        firestoreDB.collection(_coleccionDB).document();
            ...
            showDialog(
                ...
                builder: (BuildContext context) {
                  return AlertDialog(
                    ...
                    content:
                        Text("The other player has not connected to the game"),
                    actions: <Widget>[
                      Column(
                        mainAxisAlignment: MainAxisAlignment.center,
                        crossAxisAlignment: CrossAxisAlignment.center,
  ...
  Future<void> _validatePlayerConnected(
